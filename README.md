...
* 以太坊源码学习
  ...
  * 数据结构与存储
      * trie: [Modified Merkle Patricia Tree](./docs/dataStructureStorage.md#%CA%FD%BE%DD%B5%C4%D7%E9%D6%AF%D0%CE%CA%BD)
      * [区块与交易数据结构初探](./docs/blockTransactionDataStructure.md)
      * [物理存储](./docs/dataStructureStorage.md#%CA%FD%BE%DD%B5%C4%CE%EF%C0%ED%B4%E6%B4%A2)
  * （待整理）
...
| 2018/3/24 | [以太坊物理存储分析](./docs/dataStructureStorage.md#%CA%FD%BE%DD%B5%C4%CE%EF%C0%ED%B4%E6%B4%A2)<br>[数据库访问工具](./docs/plyvel.md) | 刘文炎 | :checkered_flag: |
...
| 2018/3/30 | [改进的默克尔·帕特里夏树](./docs/dataStructureStorage.md#%CA%FD%BE%DD%B5%C4%D7%E9%D6%AF%D0%CE%CA%BD) | 刘文炎 | :checkered_flag: |
